...
export default function Signup() {
    ...
    return (
        <div className={`flex h-screen ${matches ? "flex-row overflow-x-hidden box-border" : "flex-col bg-[#111]"}`}>
            ...
            >
                ...
                <div className={`${matches ? "absolute left-[100px] top-[200px]" : "flex flex-col justify-center items-center h-full"}`}>
                    {matches ? (
                        ...
                        <h1 className="text-[50px] font-[Neulis] text-[#CAD83B]">Trevo</h1>
                    )}
                </div>
            ...
            >
                <h1 className={`${matches ? "text-5xl" : "text-3xl"} font-medium mt-8 mb-4 font-[Neulis] text-center w-full max-w-md`}>
                    Create account
                </h1>
                <p className="text-white mb-1 text-sm font-[poppins] text-center w-full max-w-md">
                    We’re here to help you reach the peaks
                </p>
                <p className="text-white text-sm font-[poppins] text-center mb-8 w-full max-w-md">
                ...
                >
                    ...
                    <div className="flex justify-start w-full mb-8 mt-1">
                        <FormControlLabel
