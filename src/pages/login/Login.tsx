...
export default function Login() {
    ...
    return (
        <div className={`flex min-h-screen overflow-hidden ${matches ? "flex-row" : "flex-col bg-[#111]"}`}>
                ...
                >
                    <div className="absolute left-[100px] top-[200px]">
                        <img 
                            ...
                            alt="login title" 
                            className="w-[260px] md:w-[320px] lg:w-[480px] object-contain" 
                        />
                    </div>
                    <div className="absolute bottom-0 left-[110px] w-[65%]">
                        <img 
                            src="/trevo/assets/loginilustration.png" 
            ...
            {!matches && (
                <div className="relative w-full h-[220px] flex flex-col justify-center items-center rounded-b-[40px]"
                    style={{
                        backgroundImage: "url(/trevo/assets/backgroundlogin.png)",
                        backgroundSize: "cover",
                        backgroundPosition: "center",
                    }}>
                    <h1 className="text-[50px] font-[Neulis] text-[#CAD83B] mt-07">Trevo</h1>
                </div>
            )}
            <div 
                className={`flex flex-col justify-center items-center text-white bg-[#111]
                    ${matches 
            ? "w-1/2 p-24" // Estils pc
            : "w-full px-8 py-10 rounded-t-[40px] -mt-12 z-10" // Estilos Mvil
        }`
                }
            >
                <h1 className={`${matches ? "text-5xl" : "text-3xl"} font-medium mt-8 mb-4 font-[Neulis] text-center`}>
                    Welcome Back
                </h1>
                <p className="text-white mb-1 text-sm font-[poppins] text-center">
                    Ready to continue your fitness journey?
                </p>
                <p className="text-white text-sm font-[poppins] text-center mb-8">
                ...
                >
                    ...
                    <div className="flex justify-between items-center w-full mb-4 mt-1">
                        ...
                        />
                        <Link to="/forgot-password" className="text-sm text-purple-500 underline font-[poppins]">
                            Forgot password?
                        </Link>
                    </div>
